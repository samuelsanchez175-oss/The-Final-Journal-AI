...
final class ModelGV4ScoringTests: XCTestCase {
    func testV4TotalUsesFiftyTenForty() {
        XCTAssertEqual(ScoringEngine.v4Composite(houseFit: 1.0, autoFit: 1.0, userFit: 1.0), 100.0, accuracy: 0.001)
        XCTAssertEqual(ScoringEngine.v4Composite(houseFit: 0.5, autoFit: 0.5, userFit: 0.5), 50.0, accuracy: 0.001)
        XCTAssertEqual(ScoringEngine.v4Composite(houseFit: 1.0, autoFit: 0.0, userFit: 0.0), 50.0, accuracy: 0.001)
    }
